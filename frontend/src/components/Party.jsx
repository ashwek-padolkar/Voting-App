...
const Party = ({ party, index }) => {
  return (
    <div className="pl-4 w-full sm: flex h-60 sm:h-40 my-5 sm:items-center sm:w-2/3 mx-auto border-2 rounded-lg bg-slate-200 shadow-md">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        <div className="mt-4 flex-shrink-0 w-24 h-24 bg-indigo-100 text-indigo-500 rounded-full inline-flex items-center justify-center">
          <img class="mix-blend-multiply" src={unknownParty} alt="" />
        </div>
